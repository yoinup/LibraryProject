...
public final class GingerbreadOpenCameraInterface implements OpenCameraInterface {
   ...
   */
  @Override
  public Camera open(boolean frontCamera) {
    ...
    while (index < numCameras) {
      ...
      if (cameraInfo.facing == Camera.CameraInfo.CAMERA_FACING_FRONT && frontCamera) {
        break;
      } else if (cameraInfo.facing == Camera.CameraInfo.CAMERA_FACING_BACK && !frontCamera) {
    	break;
      }
      index++;
    }
